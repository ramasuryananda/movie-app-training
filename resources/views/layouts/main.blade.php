...
<body class="font-sans bg-gray-900 text-white">
    <nav class="border-b border-gray-800">
        <div class="container px-4 mx-auto flex place-items-start md:items-center flex-col md:flex-row justify-between py-6">
            <ul class="flex place-items-start flex-col md:flex-row md:items-center">
                <li>
            ...
            <div class="flex flex-col md:flex-row items-center">
                <div class="relative mt-3 md:mt-0">
                    <input type="text" class="bg-gray-800 text-sm rounded-full w-64 pl-8 focus:outline-none focus:shadow-lg px-4 py-1 " placeholder="Search">
