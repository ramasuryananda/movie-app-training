...
@section('content')
    <div class="movie-info border-b border-gray-800">
        <div class="container justify-center items-start mx-auto px-4 py-16 flex flex-col md:flex-row">
            <img src="{{$actor['profile_path']}}" alt="{{ $actor['name'] }}'s photo" class="w-full sm:w-1/2 h-auto object-contain" >
