    ...
    <div class="movie-info border-b border-gray-800">
        <div class="container justify-center mx-auto px-4 py-16 flex flex-col md:flex-row">
            ...
            <div class=" mt-10 md:ml-24 md:mt-0  flex-grow relative">
                ...
                <h2 class="font-semibold mt-12 text-2xl">Known For</h2>
        ...
        <div class="container mx-auto px-4 py-16">
            ...
            <ul class="list-disc leading-loose pl-5 mt-8">
                @foreach ($credits as $credit)
                    <li>{{ $credit['release_year'] }} &middot; <strong>{{ $credit['title'] }}</strong> {{ $credit['character'] ? 'as '.$credit['character'] : ' ' }} </li>
                @endforeach
